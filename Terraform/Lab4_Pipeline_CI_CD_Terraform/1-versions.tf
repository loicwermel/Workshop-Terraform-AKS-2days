...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "lwr-rg-formation"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "lwrstgformationazure"      # mettre le nom du compte de stockage créer dans le lab 1
